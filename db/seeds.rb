...
#    end
  ...
  mp1c1 = Message.create(content: "Hi", user_id: 1, poll_site_id: 8006, channel_id: 1)
  mp2cs = Message.create(content: "Hi Poll Site 2, Channel 2", user_id: 1, poll_site_id: 8003, channel_id: 42)
  mp3c2 = Message.create(content: "Hi Poll Site 3, Channel 2", user_id: 1, poll_site_id: 8002, channel_id: 42)
  mp1c3 = Message.create(content: "Hi Poll Site 2, Channel 3", user_id: 1, poll_site_id: 8001, channel_id: 42)
