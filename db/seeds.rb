...
sites_array.each do |poll_site|
  ...
  m2 = Message.create(content: "Hi Poll Site 1, Channel 3", user_id: 1, poll_site_id: 1, channel_id: 3, username: 'Lisa')
  m3 = Message.create(content: "Hey Poll Site 1, Channel 3", user_id: 1, poll_site_id: 1, channel_id: 3, username: 'Lisa')
  m4 = Message.create(content: "Hello Poll Site 1, Channel 3", user_id: 1, poll_site_id: 1, channel_id: 3, username: 'Lisa')
  m5 = Message.create(content: "Oh hey Site 2 Channel 2", user_id: 1, poll_site_id: 2, channel_id: 3, username: 'Lisa')
